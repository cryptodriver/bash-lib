...
# @description Check if a given value matches a regular expression.
#
# @param $1 mixed The value to check.
# @param $2 string The regular expression pattern to match against.
#
# @return 0 if the value matches the regular expression, 1 otherwise.
#
# @example
#   variable::is_match_regex "abc123" "[a-z]+[0-9]+"
#   # Output: 0
#
#   variable::is_match_regex "abc123" "^[A-Za-z]+$"
#   # Output: 1
#
